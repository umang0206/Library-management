...
def returnBook(): 
    ...
    headingLabel = Label(headingFrame1, text="Return Book",bg='White', fg='black', font=('Time new Roman',15))
    ...
    lb1.place(relx=0.05,rely=0.5,relheight=0.15)
        
    bookInfo1 = Entry(labelFrame,font=('Time new Roman',10))
    bookInfo1.place(relx=0.3,rely=0.5, relwidth=0.62,relheight=0.15)
    
    #Submit Button
    SubmitBtn = Button(root,text="Return",bg='green', fg='white',font=('Time new Roman',12),command=returnn)
    SubmitBtn.place(relx=0.28,rely=0.9, relwidth=0.18,relheight=0.08)
    
    quitBtn = Button(root,text="Close",bg='red', fg='white',font=('Time new Roman',12), command=root.destroy)
